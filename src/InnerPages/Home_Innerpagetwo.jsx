...
function Home_Innerpagetwo() {
  return (
    <div className='w-full my-8'>
      <div className='max-w-[1240px] mx-auto'>

        <div className='text-center py-8'>
           <h2 className='text-5xl font-bold py-4'>Trusted by all developrers across the world</h2>
           <p className='text-3xl text-gray-600'>Transform images and videos to load faster with no visual degradation</p> 
        </div>
